...
- A potential "simplification" of this would be to have 2 binary processors and 2 trinary processors. I'm talking to people who have what I've heard called "f you money"; I know that that's expensive. That being said, 2 binary processors (4) plus 2 trinary processors (6) = 10. I don't know if that is translatable into hardware: I don't truly think that it is. I'm a student, but you must admit that there is in fact some sort of beauty in that math. My next learning curve will be whether it's a sort of main delegater unit that routes to the 4 (beautiful number, because 4 * 25 = 100) processors, or a sort of main processor that has 4 subprocessors whose bases add up to 10. Cougars eat Utes for breakfast. Question of the day: what's a more beautiful equation... 2 * 5 = 10, or (2 * 2) + (2 * 3) = 10? 5 is kind of a yuck number when it comes to base 2. "use binary" says the awful crowd of critics.
